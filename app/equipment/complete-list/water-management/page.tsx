...
export const metadata: Metadata = {
  title: "Water Management Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Water Management, covering RO plants, UV sterilizers, water softeners, and misting systems for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/water-management",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Water Management Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Water Management, covering RO plants, UV sterilizers, and misting systems.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/water-management",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/water-management#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/water-management",
      name: "Water Management Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Water Management, covering RO plants, UV sterilizers, water softeners, and misting systems for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/water-management#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function WaterManagementDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Water Management, including purification, sterilization, misting, and drainage systems.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {waterManagementData.map((section, idx) => (
            <section
              key={idx}
