...
export const metadata: Metadata = {
  title: "Laboratory Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for the Laboratory, covering hot air ovens, BOD incubators, precision balances, and UV sterilization units for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/laboratory",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Laboratory Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for the Laboratory, covering hot air ovens, BOD incubators, and UV sterilization units.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/laboratory",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/laboratory#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/laboratory",
      name: "Laboratory Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for the Laboratory, covering hot air ovens, BOD incubators, precision balances, and UV sterilization units for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/laboratory#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function LaboratoryDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for the Laboratory, including incubators, filtration systems, media preparation, and precise measuring instruments.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {laboratoryData.map((section, idx) => (
            <section
              key={idx}
