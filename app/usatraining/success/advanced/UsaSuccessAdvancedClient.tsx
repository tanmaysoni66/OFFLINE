...
function SuccessContent() {
  ...
  return (
    <div className="max-w-xl mx-auto glass border border-blue-500/50 rounded-3xl p-8 text-center bg-blue-500/5">
      ...
      <Link href="/" className="inline-block px-6 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full font-bold text-sm hover:scale-105 transition-transform">
        Go to Home
      </Link>
    </div>
  );
...
export default function UsaSuccessAdvancedClient() {
  return (
