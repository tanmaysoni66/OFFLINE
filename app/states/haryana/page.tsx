...
export const metadata: Metadata = {
  ...
  description:
    "Find premium mushroom farming training, commercial setups, spawn supply, and agribusiness resources across cities in Haryana like Gurugram and Faridabad.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/states/haryana",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Find premium mushroom farming training, commercial setups, spawn supply, and agribusiness resources across cities in Haryana like Gurugram and Faridabad.",
    url: "https://organicmushroomsfarm.com/states/haryana",
    type: "website",
  },
  twitter: {
    card: "summary",
...
export default function HaryanaPage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://organicmushroomsfarm.com/states/haryana#webpage",
        url: "https://organicmushroomsfarm.com/states/haryana",
        name: "Mushroom Farming in Haryana | Cities",
        isPartOf: {
          "@id": "https://organicmushroomsfarm.com/#website",
        },
        about: {
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <section className="glass p-6 md:p-8 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden bg-white/5 dark:bg-white/5 backdrop-blur-md">
            <p className="text-[12px] md:text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed">
              Select a city in Haryana to find local mushroom farming training centers, consultants, and premium spawn suppliers. We offer complete cultivation resources and commercial setups in{" "}
              <Link
                href="/cities/haryana/gurugram"
                className="text-brand-blue hover:text-purple-500 font-semibold underline underline-offset-2 transition-colors"
              >
                Gurugram
              </Link>
              , and comprehensive guides for starting an agribusiness in the industrial areas of{" "}
              <Link
                href="/cities/haryana/faridabad"
                className="text-brand-blue hover:text-purple-500 font-semibold underline underline-offset-2 transition-colors"
              >
                Faridabad
              </Link>.
