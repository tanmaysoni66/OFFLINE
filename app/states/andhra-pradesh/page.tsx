...
export const metadata: Metadata = {
  ...
  description:
    "Find mushroom farming training, farm setups, seeds, and resources in Andhra Pradesh cities like Visakhapatnam and Vijayawada.",
  alternates: {
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <section className="glass p-6 md:p-8 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden bg-white/5 dark:bg-white/5 backdrop-blur-md">
            <p className="text-[12px] md:text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed">
              Choose a city in Andhra Pradesh to find local mushroom training, experts, and seed suppliers. We provide growing tips, business ideas, and comprehensive farm setups in major hubs like{" "}
              <Link
