...
export const metadata: Metadata = {
  title: "Cleaning & Biosecurity Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Cleaning & Biosecurity, covering high-pressure washers, foam cleaners, UV sterilization units, and pest control for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/cleaning-biosecurity",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Cleaning & Biosecurity Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Cleaning & Biosecurity, covering high-pressure washers, foam cleaners, and UV sterilization units.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/cleaning-biosecurity",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/cleaning-biosecurity#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/cleaning-biosecurity",
      name: "Cleaning & Biosecurity Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Cleaning & Biosecurity, covering high-pressure washers, foam cleaners, UV sterilization units, and pest control for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/cleaning-biosecurity#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function CleaningBiosecurityDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Cleaning & Biosecurity, ensuring a sterile environment to prevent contamination and disease outbreaks.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {cleaningBiosecurityData.map((section, idx) => (
            <section
              key={idx}
