...
export const metadata: Metadata = {
  title: "Ventilation & Air Management Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Ventilation & Air Management, covering blowers, HEPA filters, ducts, and positive-pressure systems for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/ventilation",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Ventilation & Air Management Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Ventilation & Air Management, covering blowers, HEPA filters, and ducting systems.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/ventilation",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/ventilation#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/ventilation",
      name: "Ventilation & Air Management Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Ventilation & Air Management, covering blowers, HEPA filters, ducts, and positive-pressure systems for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/ventilation#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function VentilationDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Ventilation & Air Management, including filtration, ducting, and automated pressure systems.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {ventilationData.map((section, idx) => (
            <section
              key={idx}
