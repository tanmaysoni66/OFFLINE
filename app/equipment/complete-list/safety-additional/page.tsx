...
export const metadata: Metadata = {
  title: "Safety Equipment (Additional) | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Safety (Additional), covering emergency eye-wash stations, gas detectors, spill kits, and safety showers.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/safety-additional",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Safety Equipment (Additional) | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Safety (Additional), covering emergency eye-wash stations, gas detectors, and spill kits.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/safety-additional",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/safety-additional#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/safety-additional",
      name: "Safety Equipment (Additional) | Organic Mushrooms Farm",
      description: "Detailed equipment list for Safety (Additional), covering emergency eye-wash stations, gas detectors, spill kits, and safety showers.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/safety-additional#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function SafetyAdditionalDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for additional Safety protocols, including emergency stations, gas detectors, and spill management.
          </p>
        </div>
