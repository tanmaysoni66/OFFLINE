...
export const metadata: Metadata = {
  title: "Raw Material & Grain Handling Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Raw Material & Grain Handling, covering grain cleaners, dryers, silos, conveyors, and more for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/raw-material",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Raw Material & Grain Handling Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Raw Material & Grain Handling, covering grain cleaners, dryers, and conveyors.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/raw-material",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/raw-material#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/raw-material",
      name: "Raw Material & Grain Handling Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Raw Material & Grain Handling, covering grain cleaners, dryers, silos, conveyors, and more for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/raw-material#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function RawMaterialDirectoryPage() {
  return (
    <main className="pt-24 md:pt-32 pb-16 md:pb-24 min-h-screen relative z-20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="space-y-6 md:space-y-8">
          {rawMaterialData.map((section, idx) => (
            <section
              key={idx}
