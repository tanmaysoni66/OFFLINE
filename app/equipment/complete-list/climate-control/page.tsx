...
export const metadata: Metadata = {
  title: "Climate Control Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Climate Control, covering dehumidifiers, heaters, humidity controllers, and monitoring systems for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/climate-control",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Climate Control Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Climate Control, covering dehumidifiers, heaters, and monitoring systems.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/climate-control",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/climate-control#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/climate-control",
      name: "Climate Control Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Climate Control, covering dehumidifiers, heaters, humidity controllers, and monitoring systems for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/climate-control#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function ClimateControlDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Climate Control, including humidification, heating, cooling, and automated monitoring systems.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {climateControlData.map((section, idx) => (
            <section
              key={idx}
