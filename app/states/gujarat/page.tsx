...
export const metadata: Metadata = {
  ...
  description:
    "Find mushroom farming training, commercial setups, and resources across cities in Gujarat like Ahmedabad, Surat, Vadodara, and Rajkot.",
  alternates: {
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <section className="glass p-6 md:p-8 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden bg-white/5 dark:bg-white/5 backdrop-blur-md">
            <p className="text-[12px] md:text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
              Select a city in Gujarat to find local mushroom farming training centers, consultants, and spawn suppliers. Whether you are seeking comprehensive cultivation resources and commercial setups in major hubs like{" "}
              <Link
              ...
              , our programs provide complete guidance for entrepreneurs.
            </p>
            <p className="text-[12px] md:text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed">
              Additionally, you can explore premium spawn supply and online/offline training opportunities in{" "}
              <Link
                href="/cities/gujarat/vadodara"
                className="text-brand-blue hover:text-purple-500 font-semibold underline underline-offset-2 transition-colors"
              >
                Vadodara
              </Link>
              , or learn how to establish a successful agribusiness targeting supermarkets and retail chains in{" "}
              <Link
