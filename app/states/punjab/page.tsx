...
export const metadata: Metadata = {
  ...
  description:
    "Find mushroom farming training, commercial setups, and resources across cities in Punjab like Amritsar.",
  alternates: {
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <section className="glass p-6 md:p-8 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden bg-white/5 dark:bg-white/5 backdrop-blur-md">
            <p className="text-[12px] md:text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed">
              Select a city in Punjab to find local mushroom farming training centers, consultants, and spawn suppliers. Whether you are looking for online or offline training, premium spawn supply, or complete commercial farm setup and consultancy services, you can explore resources tailored for regions like{" "}
              <Link
                href="/cities/punjab/amritsar"
