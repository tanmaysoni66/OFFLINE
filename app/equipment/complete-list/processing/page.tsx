...
export const metadata: Metadata = {
  title: "Processing Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Mushroom Processing, covering washing units, slicing machines, solar dryers, pulverizers, and vacuum packing machines.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/processing",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Processing Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Mushroom Processing, covering washing units, slicing machines, solar dryers, and vacuum packing machines.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/processing",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/processing#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/processing",
      name: "Processing Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Mushroom Processing, covering washing units, slicing machines, solar dryers, pulverizers, and vacuum packing machines.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/processing#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for mushroom Processing, including washing units, slicing machines, dryers, and vacuum packing.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {processingData.map((section, idx) => (
            <section
              key={idx}
