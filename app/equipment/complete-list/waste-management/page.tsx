...
export const metadata: Metadata = {
  title: "Waste & Environmental Management Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Waste & Environmental Management, covering spent substrate conveyors, crushers, compost recycling units, and effluent treatment systems.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/waste-management",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Waste & Environmental Management Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Waste & Environmental Management, covering substrate conveyors, crushers, and compost recycling units.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/waste-management",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/waste-management#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/waste-management",
      name: "Waste & Environmental Management Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Waste & Environmental Management, covering spent substrate conveyors, crushers, compost recycling units, and effluent treatment systems.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/waste-management#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function WasteManagementDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Waste & Environmental Management, ensuring sustainable recycling of spent compost and safe effluent treatment.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {wasteManagementData.map((section, idx) => (
            <section
              key={idx}
