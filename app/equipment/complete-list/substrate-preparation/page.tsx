...
export const metadata: Metadata = {
  title: "Substrate Preparation Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Substrate Preparation, covering pre-wetting tanks, spray lines, moisture meters, and cooling systems for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/substrate-preparation",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Substrate Preparation Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Substrate Preparation, covering pre-wetting tanks, spray lines, and cooling systems.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/substrate-preparation",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/substrate-preparation#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/substrate-preparation",
      name: "Substrate Preparation Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Substrate Preparation, covering pre-wetting tanks, spray lines, moisture meters, and cooling systems for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/substrate-preparation#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function SubstratePreparationDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Substrate Preparation, including wetting, screening, cooling, and transfer machinery.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {substratePrepData.map((section, idx) => (
            <section
              key={idx}
