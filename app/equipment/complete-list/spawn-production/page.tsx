...
export const metadata: Metadata = {
  title: "Spawn Production Equipment | Organic Mushrooms Farm",
  description:
    "Detailed equipment list for Spawn Production, covering grain cleaners, incubators, cold rooms, and liquid culture systems for commercial mushroom farming.",
  alternates: {
    canonical: "https://organicmushroomsfarm.com/equipment/complete-list/spawn-production",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Spawn Production Equipment | Organic Mushrooms Farm",
    description:
      "Detailed equipment list for Spawn Production, covering grain cleaners, incubators, and liquid culture systems.",
    url: "https://organicmushroomsfarm.com/equipment/complete-list/spawn-production",
...
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/spawn-production#webpage",
      url: "https://organicmushroomsfarm.com/equipment/complete-list/spawn-production",
      name: "Spawn Production Equipment | Organic Mushrooms Farm",
      description: "Detailed equipment list for Spawn Production, covering grain cleaners, incubators, cold rooms, and liquid culture systems for commercial mushroom farming.",
      isPartOf: {
        "@id": "https://organicmushroomsfarm.com/#website",
      },
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://organicmushroomsfarm.com/equipment/complete-list/spawn-production#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
...
export default function SpawnProductionDirectoryPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-[11px] sm:text-[11.5px] text-slate-600 dark:text-slate-400 mb-8 max-w-2xl leading-relaxed">
            Specialized directory detailing all necessary equipment and materials for Spawn Production — Additional, including incubation, liquid culture, and storage systems.
          </p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {spawnProductionData.map((section, idx) => (
            <section
              key={idx}
